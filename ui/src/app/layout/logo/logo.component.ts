...
@Component({
  selector: 'app-logo',
  template: ` <svg class="logo" viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
    <title i18n="@@app.logo-title2">Spring Cloud Dataflow UI</title>
    ...
    <g>
      ...
      />
      <path fill="currentColor" d="M142.2,259.7v-22.4l-4.5,1.5l-1.6-4.8l7.5-2.8h5.2v28.4H142.2z" />
      <path
        fill="currentColor"
      ...
      />
      <path fill="currentColor" d="M199,237.1v-16.9l-3.4,1.2l-1.2-3.6l5.7-2.1h3.9v21.5H199z" />
      <path fill="currentColor" d="M218.7,224.9v-15.6l-3.1,1.1l-1.1-3.3l5.2-1.9h3.6v19.8H218.7z" />
      <path
        fill="currentColor"
