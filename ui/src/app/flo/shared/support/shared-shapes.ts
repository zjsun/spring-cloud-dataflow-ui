...
export function loadSharedShapes(): void {
  loadShapes();
  ...
  joint.shapes.flo.DataflowPaletteGroupHeader = joint.shapes.basic.Generic.extend({
    ...
    markup:
      '<g><rect class="outer"/><rect class="group-label-bg"/><text class="group-label"/><image class="collapse-handle light"/><image class="collapse-handle2 dark"/><polyline class="group-line"/></g>',
