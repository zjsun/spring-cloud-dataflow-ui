    ...
    const elements = new Map<string, Flo.ElementMetadata>()
      .set(
        ...
        this.createMetadata(
          'tap',
          OTHER_GROUP_TYPE,
          $localize `:@@metamodel.msg01:Tap into an existing app`,
          new Map<string, Flo.PropertyMetadata>().set('name', {
            name: $localize `:@@metamodel.msg02:Source Destination Name`,
            id: 'name',
            defaultValue: '',
            description: $localize `:@@metamodel.msg03:the identifier of the producer endpoint in a stream in the form <stream-name>.<app/app-name>`,
            pattern: '[\\w_]+[\\w_-]*\\.[\\w_]+[\\w_-]*'
          }),
          {
      ...
      .set(
        ...
        this.createMetadata(
          'destination',
          OTHER_GROUP_TYPE,
          $localize `:@@metamodel.msg04:A destination channel that can be used as a source or a sink`,
          new Map<string, Flo.PropertyMetadata>().set('name', {
            name: $localize `:@@metamodel.msg05:name`,
            id: 'name',
            defaultValue: '',
            description: $localize `:@@metamodel.msg06:the input/output destination name`,
            pattern: '[\\w_]+[\\w_-]*'
          }),
          {
            'fixed-name': true
